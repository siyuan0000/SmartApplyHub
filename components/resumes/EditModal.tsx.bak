...
import { SectionType, useResumeEditor } from '@/hooks/useResumeEditor'
...
export function EditModal({ 
  ...
  const { setEditingSection } = useResumeEditor()
  ...
  }, [isOpen, section, setEditingSection])
